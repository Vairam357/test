...
//		enterByXpath("(//input[@placeholder='Enter'])[2]", "Qwerty789");
	...
	public AccountsPage clickAccountsTab() throws InterruptedException
	{
		...
		clickByXpath("//span[contains(text(),'Accounts')]");
		return this;
	}
	...
	public AccountsPage verifyAccountOverviewPageElements() throws InterruptedException
	{
		...
		verifyElementisPresent("//span/following::h4[contains(text(),'Savings Accounts')]", "Savings Accounts");
	...
	public AccountsPage selectBankAndBranch() throws InterruptedException
	{
		...
		clickSearchButton();
		clickByXpath("(//mat-radio-button[@value='option 1'])[1]");	
		clickOKbtn();
		return this;
	}
...
//		verifyElementisPresent("//div[contains(text(),'Recent Transactions')]", "Recent Transactions Heading");
	...
	public AccountsPage clickAccountStatementLink() throws InterruptedException
	{
		System.out.println("Click Account Statement Link");
		clickByXpath("//div[contains(text(),'Account Statement')]");
		return this;
	}
	
	public AccountsPage verifyAccountStatementHeading() throws InterruptedException
	{
		System.out.println("Verify Account Statement Heading");
		verifyElementisPresent("//div[contains(text(),'Account Statement')]", "Account Statement Heading");
		return this;
	}
	...
	public AccountsPage selectCustomStatement() throws InterruptedException
	{
		...
		selectStartDateForCustomStatement("01", "Feb" , "2021");
		selectEndDateForCustomStatement("Feb" , "2021");
...
//		clickByXpath("//td[@class='active available end-date in-range start-date today ng-star-inserted']");
	...
	public AccountsPage selectEndDateForCustomStatement(String Month, String Year) throws InterruptedException
	{
...
//		DOB.moveToElement(driver.findElement(By.xpath("//tbody/tr//td//span[contains(text(),'"+Date+"')]"))).click().perform();
	...
	public AccountsPage downloadStatement()
	{
	...
	public AccountsPage clickTermDepositMenu() throws InterruptedException
	{
		System.out.println("Click Term Deposit Menu");
		clickByXpath("//button/span[contains(text(),'Term')]");
		return this;
	}
	...
	public AccountsPage clickDepositStatementLink() throws InterruptedException
	{
		System.out.println("Click Deposit Statement Link");
		clickByXpath("//div[contains(text(),'Deposit Statement')]");
		return this;
	}
	
	public AccountsPage verifyDepositStatementHeading() throws InterruptedException
	{
		System.out.println("Verify Deposit Statement Heading");
		verifyElementisPresent("//div[contains(text(),'Deposit Statement')]", "Deposit Statement Heading");
		return this;
	}
