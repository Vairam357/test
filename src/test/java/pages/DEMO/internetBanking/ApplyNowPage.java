...
public class ApplyNowPage extends wrappers.ProjectWrappers  {
	...
	public ApplyNowPage verifyCASASuccessMessage()
	{
		...
		verifyTextByXpath("//*[contains(text(),'Success ! Your request for opening CASA Account has been placed successfully!')]", "Success! The request for CASA Account opening has been placed successfully!");
		return this;
	}
...
//		clickByXpath("(//div[@class='ng-option ng-option-selected ng-option-marked ng-star-inserted'])[1]");
	...
	public ApplyNowPage verifyFixedDepositSuccessMessage()
	{
		...
		verifyElementisPresent("//*[contains(text(),'Success ! Your request for opening Fixed Account has been placed successfully!')]", "Fixed Deposit Success Message");
		verifyTextByXpath("//*[contains(text(),'Success ! Your request for opening Fixed Account has been placed successfully!')]", "Success ! Your request for opening Fixed Account has been placed successfully!");
		return this;
	}
