...
public class DashboardPage extends wrappers.ProjectWrappers  {
	...
	// Dynamic widget
	public DashboardPage verifyDynamicWidget()
	{
	...
	public DashboardPage verifyDynamicWidgetSecond()
	{
		System.out.println("Verify Dynamic Widget Second");
	...
	public DashboardPage clickLoanButton()
	{
