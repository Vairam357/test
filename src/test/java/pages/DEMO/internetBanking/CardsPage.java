...
public class CardsPage extends wrappers.ProjectWrappers  {
	...
	public CardsPage clickCardsDetailsLink()
	{
		System.out.println("Click Card Details Link");
		clickByXpath("//*[contains(text(),'Card Details')]");
		return this;
	}
	
	public CardsPage clickCardStatementLink()
	{
		System.out.println("Click Card Statement Link");
		clickByXpath("//div[contains(text(),'Card Statement')]]");
		return this;
	}
	...
	public CardsPage clickPayCreditCardLink()
	{
		...
		clickByXpath("//div[contains(text(),'Pay Credit Card')]");
		return this;
	}
	
	public CardsPage clickCreditCardDetailsButton()
	{
		System.out.println("Click Credit Card Details Bitton");
		clickByXpath("//*[contains(text(),'Credit Card Details ')]");
		return this;
	}

	public CardsPage clickCreditCardStatementButton()
	{
		System.out.println("Click Credit Card Statement Button");
		clickByXpath("//*[contains(text(),'Credit Card Statement')]");
		return this;
	}
	
	public CardsPage clickManageCardButton()
	{
		System.out.println("Click Manage Card Button");
		clickByXpath("//div[contains(text(),'Manage Card')]");
		return this;
	}
	...
	public CardsPage clickDownloadStatement()
	{
		System.out.println("Click Download Statement");
		clickByXpath("//span[contains(text(),'Download Statement')]");
		return this;
	}
	...
	public CardsPage verifyCardType()
	{
	...
	public CardsPage verifyCardName()
	{
		System.out.println("Verify Card Name");
		verifyElementisPresent("//div[contains(text(),'Card Name')]", "Card Name");
		return this;
	}
	
	public CardsPage verifyCardNumber()
	{
	...
	// Toggle Button
	public CardsPage clickOnButton()
	{
	...
	public CardsPage clickOffButton()
	{
	...
	public CardsPage clickOkButton()
	{
