...
//		verifyElementisPresentById("registration_input_card_limit", "Credit Card Limit Input");
	...
	public RegistrationPage verifyLabelsInCCDetailsPage()
	{
...
//		verifyTextById("registration_label_card_expiry", "Expiry Date");
	...
	public RegistrationPage enterCreditCardNumber()
	{
		...
		RegistrationCreditCardNumber = enterByXpathWithRandomNumbers("shared_creditcard_input_cardno", "4", "4");
	...
	public RegistrationPage clearAndEnterCreditCardNumber() throws InterruptedException
	{
		...
		driver.findElement(By.id("shared_creditcard_input_cardno")).clear();
		enterByXpathWithRandomNumbers("shared_creditcard_input_cardno", "4", "6");
		Thread.sleep(2000);
		return this;
	}
	...
	public RegistrationPage enterIncorrectCreditCardNumber()
	{
		...
		enterById("shared_creditcard_input_cardno", "9632587412321");
		return this;
	}
...
//		clickByXpath("(//mat-icon[contains(text(),'date_range')])[1]");
		clickById("registration_input_card_expiry");
...
//		verifyTextById("registration_label_DOB_is_mandatory", "DOB is mandatory");
	...
	public RegistrationPage verifyNextButtonEnabled() 
	{
		verifyElementisPresentById("shared_creditcard_button_next", "Next button");
//		String DefaultColor = driver.findElement(By.id("shared_creditcard_button_next-color")).getCssValue("background-color");
//		String HightlightedColor = driver.findElement(By.id("shared_creditcard_button_next")).getCssValue("background-color");
//		System.out.println(DefaultColor);
//		System.out.println(HightlightedColor);
//		if(!DefaultColor.equals(HightlightedColor))
//		{
//			System.out.println("Registration NEXT button is enabled!");
//			reportStep("Registration NEXT button is enabled!", "PASS");
//		}
//		else
//		{
//			System.out.println("Registration NEXT button is disabled!");
//			reportStep("Registration NEXT button is disabled!", "FAIL");
//		}
		return this;
	}
...
//		clickByXpath("//button/span[contains(text(),'Cancel')]");
	...
	public RegistrationPage verifyUniqueUserName() throws InterruptedException{
		System.out.println("Verify Unique User Name");	
		enterUserName();
		clickSubmitBtn();
//	  	.verifyUsernameTick();
		String user1= getobjprop("RegistrationUserName");
		System.out.println("UserName 1 :"+ user1);
		clickCancelBtn();
	  	clickRegisterNowBtn();
	  	clickAgreeBtn();
		enterCreditCardNumber();
	  	...
	  	enterSMSOTP();
	  	click2faNextBtn();
//	  	verifyCreateYourUsernameHeading();
	  	enterUserName();
	  	clickSubmitBtn();
//	  	verifyUsernameTick();
	  	String user2= getobjprop("RegistrationUserName");
		System.out.println("UserName 2 :"+ user2);

		if(user1!=user2)
		{
			System.out.println("Unique User Name ID is Unique and not same");
			reportStep("Unique User Name ID is Unique and not same", "PASS");
		}
		else
		{
			System.out.println("Unique User Name ID is Not Unique and same");
			reportStep("Unique User Name ID is Not Unique and same", "FAIL");
		}
...
//		verifyTextByXpath("//mat-error[contains(text(),'Your registration has failed')]", "Your registration has failed already exist");
	...
	public RegistrationPage verifyRegistrationSuccessMessage() throws InterruptedException {
		...
		verifyTextByXpath("//h3[contains(text(),'Registration completed successfully.')]", Message);
...
//		clickById("registration_button_sign_in_internet_banking");
	...
	public RegistrationPage clickHomeTab()
	{
	...
	public RegistrationPage clickAboutUsTab()
	{
	...
	public RegistrationPage clickLocateUsTab()
	{
	...
	public RegistrationPage clickContactUsTab()
	{
	...
	public RegistrationPage clickViewDemoTab()
	{
	...
	public RegistrationPage clickFAQTab()
	{
	...
	public RegistrationPage selectLanguage(String Lang)
	{
	...
	public RegistrationPage clickFacebookIcon()
	{
	...
	public RegistrationPage clickLinkedInIcon()
	{
	...
	public RegistrationPage clickTwitterIcon()
	{
